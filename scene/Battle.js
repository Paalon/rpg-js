...
module.exports = class Battle extends Scene { // gstateに依存
  ...
  init() { // 初期化処理
    ...
    */
    ...
    tatakau.position.set(WINDOW.WIDTH * 0.7, WINDOW.HEIGHT * 0.6);
    mahou.position.set(WINDOW.WIDTH * 0.7, WINDOW.HEIGHT * 0.7);
    nigeru.position.set(WINDOW.WIDTH * 0.7, WINDOW.HEIGHT * 0.8);
